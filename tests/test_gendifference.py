...
@pytest.mark.parametrize("path1, path2, style, expected", [
    (fixture_paths.FILE1_JSON, 
     ...
     'stylish', 
     excepted_result('tests/fixtures/excepted_result.txt')),
    ...
    (fixture_paths.FILE3_JSON, 
     ...
     'stylish', 
     excepted_result('tests/fixtures/excepted_result_nested.txt')),
    ...
    (fixture_paths.FILE3_JSON, 
     fixture_paths.FILE4_JSON, 
     'plain', 
     excepted_result('tests/fixtures/excepted_result_plain.txt')),
    (fixture_paths.FILE3_YAML, 
     fixture_paths.FILE4_YAML, 
     'plain', 
     excepted_result('tests/fixtures/excepted_result_plain.txt')),
    (fixture_paths.FILE3_JSON, 
     fixture_paths.FILE4_JSON, 
     'json', 
     excepted_result('tests/fixtures/excepted_result_json.txt')),
    (fixture_paths.FILE3_YAML, 
     fixture_paths.FILE4_YAML, 
     'json', 
     excepted_result('tests/fixtures/excepted_result_json.txt'))
